...
class ValidatorsController extends Controller
{
    ...
    {
        $searchModel = new SearchValidators();
    ...
    /**
     * Creates a new Validators model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Validators();
    ...
    /**
     * Updates an existing Validators model.
    ...
    /**
     * Deletes an existing Validators model.
